...
(() => {
  ...
  // node_modules/@storybook/addon-onboarding/dist/_browser-chunks/chunk-B266DSPW.js
  var STORYBOOK_ADDON_ONBOARDING_CHANNEL, ADDON_CONTROLS_ID, init_chunk_B266DSPW = __esm({
    "node_modules/@storybook/addon-onboarding/dist/_browser-chunks/chunk-B266DSPW.js"() {
      init_define_module();
      init_define_process_env();
      init_define_process_env_NODE_PATH();
      STORYBOOK_ADDON_ONBOARDING_CHANNEL = "STORYBOOK_ADDON_ONBOARDING_CHANNEL", ADDON_CONTROLS_ID = "addon-controls";
    }
  });

  // node_modules/@storybook/addon-onboarding/dist/_browser-chunks/chunk-CBI7MY27.js
  var __create, __defProp2, __getOwnPropDesc, __getOwnPropNames2, __getProtoOf, __hasOwnProp, __name, __commonJS, __copyProps, __toESM, init_chunk_CBI7MY27 = __esm({
    "node_modules/@storybook/addon-onboarding/dist/_browser-chunks/chunk-CBI7MY27.js"() {
      init_define_module();
      init_define_process_env();
      init_define_process_env_NODE_PATH();
      __create = Object.create, __defProp2 = Object.defineProperty, __getOwnPropDesc = Object.getOwnPropertyDescriptor, __getOwnPropNames2 = Object.getOwnPropertyNames, __getProtoOf = Object.getPrototypeOf, __hasOwnProp = Object.prototype.hasOwnProperty, __name = (target, value) => __defProp2(target, "name", { value, configurable: !0 }), __commonJS = (cb, mod) => function() {
  ...
  // node_modules/@storybook/addon-onboarding/dist/_browser-chunks/Onboarding-XBLXWDOE.js
  var Onboarding_XBLXWDOE_exports = {};
  __export(Onboarding_XBLXWDOE_exports, {
    default: () => Onboarding
  });
  function y(y2, z2 = {}) {
    ...
    let I = [], G = [], K = __name(() => P2(b() * (N - 1)), "K"), Q = __name((e2, t2) => j !== "rectangles" && (e2 === "circles" || k(t2)), "Q");
    function R(e2, t2) {
      let r2 = K(), a2 = Q(j, r2), o2 = __name((t3, r3) => e2.style.setProperty(t3, r3 + ""), "o");
  ...
  function treeChanges(previousData, data) {
    ...
    let added = __name((key, value) => {
      try {
        return compareValues(previousData, data, { key, type: "added", value });
      } catch {
        return !1;
      }
    }, "added"), changed = __name((key, actual, previous) => {
      try {
    ...
    }, "changed"), changedFrom = __name((key, previous, actual) => {
    ...
    }, "changedFrom"), decreased = __name((key, actual, previous) => {
      if (!src_default.defined(key))
        return !1;
      try {
    ...
    }, "filled"), increased = __name((key, actual, previous) => {
      if (!src_default.defined(key))
        return !1;
      try {
    ...
    }, "increased"), removed = __name((key, value) => {
      try {
  ...
  function getRoundedOffsets(data, shouldRound) {
    var _data$offsets = data.offsets, popper = _data$offsets.popper, reference = _data$offsets.reference, round = Math.round, floor = Math.floor, noRound = __name(function(v2) {
      return v2;
    }, "noRound"), referenceWidth = round(reference.width), popperWidth = round(popper.width), isVertical = ["left", "right"].indexOf(data.placement) !== -1, isVariation = data.placement.indexOf("-") !== -1, sameWidthParity = referenceWidth % 2 === popperWidth % 2, bothOddWidth = referenceWidth % 2 === 1 && popperWidth % 2 === 1, horizontalToInteger = shouldRound ? isVertical || isVariation || sameWidthParity ? round : floor : noRound, verticalToInteger = shouldRound ? round : noRound;
    return {
  ...
  function preventOverflow(data, options) {
    ...
    var order = options.priority, popper = data.offsets.popper, check = {
      primary: __name(function(placement) {
      ...
      secondary: __name(function(placement) {
  ...
  function equalMap2(left, right) {
    ...
    try {
      ...
      try {
        _d && !_d.done && (_a9 = _c.return) && _a9.call(_c);
      } finally {
  ...
  function equalSet2(left, right) {
    ...
    try {
      ...
      try {
        _c && !_c.done && (_a9 = _b.return) && _a9.call(_b);
      } finally {
  ...
  function getIterables2(previousData, data, _a9) {
    var _b = _a9 === void 0 ? {} : _a9, key = _b.key, left = nested2(previousData, key), right = nested2(data, key);
  ...
  function treeChanges2(previousData, data) {
    ...
    if (![previousData, data].every(function(d2) {
      ...
      throw new Error("Expected plain objects or array");
    var added = __name(function(key, value) {
      try {
        return compareValues2(previousData, data, { key, type: "added", value });
      } catch {
        return !1;
      }
    }, "added"), changed = __name(function(key, actual, previous) {
      try {
    ...
    }, "changed"), changedFrom = __name(function(key, previous, actual) {
    ...
    }, "decreased"), emptied = __name(function(key) {
      try {
    ...
    }, "emptied"), filled = __name(function(key) {
      try {
        var _a9 = getIterables2(previousData, data, { key }), left = _a9[0], right = _a9[1];
        return !left.length && !!right.length;
      } catch {
    ...
    }, "filled"), increased = __name(function(key, actual, previous) {
      if (!esm_default2.defined(key))
        return !1;
      try {
    ...
    }, "increased"), removed = __name(function(key, value) {
      try {
  ...
  function _getPrototypeOf(o2) {
    return _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : __name(function(o3) {
      return o3.__proto__ || Object.getPrototypeOf(o3);
    }, "_getPrototypeOf"), _getPrototypeOf(o2);
  }
  function _setPrototypeOf(o2, p2) {
    return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : __name(function(o3, p3) {
  ...
  function once(element, event, cb) {
    ...
    _nextCB = __name(function(e2) {
      cb(e2), off(element, event, _nextCB);
    }, "nextCB"), on(element, event, _nextCB, capture);
  }
  function noop() {
  }
  ...
  function canUseDOM2() {
    var _a9;
    return !!(typeof window < "u" && ((_a9 = window.document) != null && _a9.createElement));
  }
  ...
  function getElementPosition(element, offset2, skipFix) {
    var _a9, _b, _c;
    let elementRect = getClientRect2(element), parent = getScrollParent2(element, skipFix), hasScrollParent = hasCustomScrollParent(element, skipFix), isFixedTarget = hasPosition(element), parentTop = 0, top = (_a9 = elementRect?.top) != null ? _a9 : 0;
  ...
  function getScrollTo(element, offset2, skipFix) {
    ...
    if (!element)
      return 0;
    let { offsetTop = 0, scrollTop = 0 } = (_a9 = (0, import_scrollparent.default)(element)) != null ? _a9 : {}, top = element.getBoundingClientRect().top + scrollTop;
  ...
  function replaceLocaleContent(input, step, steps) {
    let replacer = __name((text) => text.replace("{step}", String(step)).replace("{steps}", String(steps)), "replacer");
  ...
  function getStyles2(props, step) {
    var _a9, _b, _c, _d, _e;
    let { floaterProps, styles } = props, mergedFloaterProps = (0, import_deepmerge3.default)((_a9 = step.floaterProps) != null ? _a9 : {}, floaterProps ?? {}), mergedStyles = (0, import_deepmerge3.default)(styles ?? {}, (_b = step.styles) != null ? _b : {}), options = (0, import_deepmerge3.default)(defaultOptions2, mergedStyles.options || {}), hideBeacon2 = step.placement === "center" || step.disableBeacon, { width } = options;
  ...
  function GuidedTour({
    ...
    }, [step, steps]), stepIndex === null ? null : react_default.createElement(
      components_default2,
      {
        continuous: !0,
        steps,
...
`).length, steps = [
    ...
    return react_default.createElement(ThemeProvider, { theme }, showConfetti && react_default.createElement(Confetti, null), step === "1:Intro" ? react_default.createElement(SplashScreen, { onDismiss: () => setStep("2:Controls") }) : step === "6:IntentSurvey" ? react_default.createElement(IntentSurvey, { onComplete: completeOnboarding, onDismiss: disableOnboarding }) : react_default.createElement(
      GuidedTour,
      {
        step,
        steps,
    ...
    "node_modules/@storybook/addon-onboarding/dist/_browser-chunks/Onboarding-XBLXWDOE.js"() {
      ...
      require_scroll = __commonJS({
        "../../node_modules/scroll/index.js"(exports, module) {
          ...
          function make(prop) {
            return __name(function(el, to, opts, cb) {
              opts = opts || {}, typeof opts == "function" && (cb = opts, opts = {}), typeof cb != "function" && (cb = noop3);
        ...
        "../../node_modules/scrollparent/scrollparent.js"(exports, module) {
          (function(root, factory) {
            ...
            return __name(scrollParent2, "scrollParent"), scrollParent2;
          });
        }
      }), require_react_innertext = __commonJS({
        "../../node_modules/react-innertext/index.js"(exports, module) {
          "use strict";
          var hasProps = __name(function(jsx2) {
            return Object.prototype.hasOwnProperty.call(jsx2, "props");
          }, "hasProps"), reduceJsxToString = __name(function(previous, current) {
            return previous + innerText2(current);
          }, "reduceJsxToString"), innerText2 = __name(function(jsx2) {
        ...
        "../../node_modules/deepmerge/dist/cjs.js"(exports, module) {
          "use strict";
          var isMergeableObject = __name(function(value) {
          ...
          __name(deepmerge4, "deepmerge"), deepmerge4.all = __name(function(array, options) {
        ...
        "../../node_modules/object-assign/index.js"(exports, module) {
          ...
          __name(shouldUseNative, "shouldUseNative"), module.exports = shouldUseNative() ? Object.assign : function(target, source) {
        ...
        "../../node_modules/prop-types/checkPropTypes.js"(exports, module) {
          "use strict";
          var printWarning = __name(function() {
          }, "printWarning");
          ReactPropTypesSecret = require_ReactPropTypesSecret(), loggedTypeFailures = {}, has = require_has(), printWarning = __name(function(text) {
          ...
          __name(checkPropTypes, "checkPropTypes"), checkPropTypes.resetWarningCache = function() {
            loggedTypeFailures = {};
        ...
        "../../node_modules/prop-types/factoryWithTypeCheckers.js"(exports, module) {
          "use strict";
          var ReactIs = require_react_is(), assign = require_object_assign(), ReactPropTypesSecret = require_ReactPropTypesSecret(), has = require_has(), checkPropTypes = require_checkPropTypes(), printWarning = __name(function() {
          }, "printWarning");
          printWarning = __name(function(text) {
            var message = "Warning: " + text;
            typeof console < "u" && console.error(message);
            try {
              throw new Error(message);
          ...
          __name(emptyFunctionThatReturnsNull, "emptyFunctionThatReturnsNull"), module.exports = function(isValidElement2, throwOnDirectAccess) {
            ...
            __name(PropTypeError, "PropTypeError"), PropTypeError.prototype = Error.prototype;
            ...
            function createPrimitiveTypeChecker(expectedType) {
              ...
              return __name(validate, "validate"), createChainableTypeChecker(validate);
            }
              ...
              function validate(props, propName, componentName, location, propFullName) {
                for (var propValue = props[propName], i2 = 0; i2 < expectedValues.length; i2++)
                  if (is4(propValue, expectedValues[i2]))
                    return null;
                var valuesString = JSON.stringify(expectedValues, __name(function(key, value) {
...
Valid keys: ` + JSON.stringify(Object.keys(shapeTypes), null, "  ")
            ...
            return __name(getClassName, "getClassName"), ReactPropTypes.checkPropTypes = checkPropTypes, ReactPropTypes.resetWarningCache = checkPropTypes.resetWarningCache, ReactPropTypes.PropTypes = ReactPropTypes, ReactPropTypes;
          };
        }
        ...
        "../../node_modules/prop-types/factoryWithThrowingShims.js"(exports, module) {
          ...
          __name(emptyFunctionWithReset, "emptyFunctionWithReset"), emptyFunctionWithReset.resetWarningCache = emptyFunction, module.exports = function() {
            ...
            __name(shim, "shim"), shim.isRequired = shim;
            function getShim() {
              return shim;
            }
      ...
      __name(y, "y");
      f = 200, g = 800, m = 0.1, h = 0.3, v = 0.5, x = Math.abs, b = Math.random, P2 = Math.round, B = Math.max, W = __name((e2) => document.createElement(e2), "W"), _ = __name((e2, t2) => e2.appendChild(t2), "_"), S = __name((e2, t2) => Array.from({ length: e2 }, (r2, a2) => ({ color: t2[a2 % t2.length], degree: 360 * a2 / e2 })), "S"), w = __name((e2, t2 = 2) => P2((e2 + Number.EPSILON) * 10 ** t2) / 10 ** t2, "w"), C = __name((e2, t2, r2, a2, o2) => (e2 - t2) * (o2 - a2) / (r2 - t2) + a2, "C"), L = __name((e2, t2) => e2 + t2 > 360 ? e2 + t2 - 360 : e2 + t2, "L"), M = __name(() => b() > 0.5, "M"), T = Object.entries, N = 6, k = __name((e2) => e2 !== 1 && M(), "k");
      __name(F, "F");
      Wrapper = styled.div({
        zIndex: 9999,
        position: "fixed",
        ...
        height: "100%",
        pointerEvents: "none"
      }), Confetti = react_default.memo(__name(function({
        timeToFade = 5e3,
        colors = ["#CA90FF", "#FC521F", "#66BF3C", "#FF4785", "#FFAE00", "#1EA7FD"],
        ...confettiProps
      }) {
        return react_default.createElement(Wrapper, null, react_default.createElement(
          F,
          {
            colors,
            particleCount: 200,
      ...
      isFunction = isOfType("function"), isNull = __name((value) => value === null, "isNull"), isRegex = __name((value) => Object.prototype.toString.call(value).slice(8, -1) === "RegExp", "isRegex"), isObject = __name((value) => !isUndefined(value) && !isNull(value) && (isFunction(value) || typeof value == "object"), "isObject"), isUndefined = isOfType("undefined");
      ...
      classCallCheck = __name(function(instance, Constructor) {
        if (!(instance instanceof Constructor))
          throw new TypeError("Cannot call a class as a function");
        ...
        return __name(defineProperties, "defineProperties"), function(Constructor, protoProps, staticProps) {
          return protoProps && defineProperties(Constructor.prototype, protoProps), staticProps && defineProperties(Constructor, staticProps), Constructor;
        };
      })(), defineProperty = __name(function(obj, key, value) {
      ...
      }, "defineProperty"), _extends = Object.assign || function(target) {
      ...
      modifiers = {
        ...
        function Popper2(reference, popper) {
          ...
          }, this.update = debounce(this.update.bind(this)), this.options = _extends({}, Popper2.Defaults, options), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
          }, this.reference = reference && reference.jquery ? reference[0] : reference, this.popper = popper && popper.jquery ? popper[0] : popper, this.options.modifiers = {}, Object.keys(_extends({}, Popper2.Defaults.modifiers, options.modifiers)).forEach(function(name) {
      ...
      isFunction3 = isOfType4("function"), isNull2 = __name(function(value) {
        return value === null;
      }, "isNull"), isRegex2 = __name(function(value) {
        return Object.prototype.toString.call(value).slice(8, -1) === "RegExp";
      }, "isRegex"), isObject2 = __name(function(value) {
        return !isUndefined2(value) && !isNull2(value) && (isFunction3(value) || typeof value == "object");
      }, "isObject"), isUndefined2 = isOfType4("undefined"), __values = function(o2) {
      ...
      ReactFloaterPortal = (function(_React$Component) {
        ...
        return __name(ReactFloaterPortal2, "ReactFloaterPortal"), _createClass(ReactFloaterPortal2, [{ key: "componentDidMount", value: __name(function() {
          canUseDOM() && (this.node || this.appendNode(), isReact16 || this.renderPortal());
        }, "componentDidMount") }, { key: "componentDidUpdate", value: __name(function() {
          canUseDOM() && (isReact16 || this.renderPortal());
        }, "componentDidUpdate") }, { key: "componentWillUnmount", value: __name(function() {
        ...
        }, "componentWillUnmount") }, { key: "appendNode", value: __name(function() {
        ...
        }, "appendNode") }, { key: "renderPortal", value: __name(function() {
        ...
        }, "renderPortal") }, { key: "renderReact16", value: __name(function() {
        ...
        }, "renderReact16") }, { key: "render", value: __name(function() {
          return isReact16 ? this.renderReact16() : null;
        }, "render") }]), ReactFloaterPortal2;
      ...
      FloaterArrow = (function(_React$Component) {
        ...
        return __name(FloaterArrow2, "FloaterArrow"), _createClass(FloaterArrow2, [{ key: "parentStyle", get: __name(function() {
        ...
        }, "get") }, { key: "render", value: __name(function() {
      ...
      Floater = (function(_React$Component) {
        ...
        return __name(Floater2, "Floater"), _createClass(Floater2, [{ key: "style", get: __name(function() {
      ...
      ReactFloaterWrapper = (function(_React$Component) {
        ...
        return __name(ReactFloaterWrapper2, "ReactFloaterWrapper"), _createClass(ReactFloaterWrapper2, [{ key: "render", value: __name(function() {
      ...
      _excluded = ["arrow", "flip", "offset"], POSITIONING_PROPS = ["position", "top", "right", "bottom", "left"], ReactFloater = (function(_React$Component) {
        ...
        return __name(ReactFloater2, "ReactFloater"), _createClass(ReactFloater2, [{ key: "componentDidMount", value: __name(function() {
          if (canUseDOM()) {
        ...
        }, "componentDidMount") }, { key: "componentDidUpdate", value: __name(function(prevProps, prevState) {
          if (canUseDOM()) {
        ...
        }, "componentWillUnmount") }, { key: "initPopper", value: __name(function() {
          ...
          if (placement === "center")
            ...
            }, "onCreate"), onUpdate: __name(function(data) {
              _this2.popper = data;
          ...
          if (positionWrapper) {
            ...
            new popper_default(this.target, this.wrapperRef, { placement: wrapperOptions.placement || placement, modifiers: { arrow: { enabled: !1 }, offset: { offset: "0, ".concat(wrapperOffset, "px") }, flip: { enabled: !1 } }, onCreate: __name(function(data) {
        ...
        }, "initPopper") }, { key: "rebuildPopper", value: __name(function() {
          var _this3 = this;
        ...
        }, "rebuildPopper") }, { key: "changeWrapperPosition", value: __name(function(_ref) {
          var target = _ref.target, wrapperOptions = _ref.wrapperOptions;
          this.setState({ positionWrapper: wrapperOptions.position && !!target });
        }, "changeWrapperPosition") }, { key: "toggle", value: __name(function(forceStatus) {
        ...
        }, "get") }, { key: "options", get: __name(function() {
          var options = this.props.options;
          return (0, import_deepmerge.default)(DEFAULTS, options || {});
        }, "get") }, { key: "styles", get: __name(function() {
          ...
          return nextStyles;
        }, "get") }, { key: "target", get: __name(function() {
          if (!canUseDOM()) return null;
      ...
      __defProp3 = Object.defineProperty, __defNormalProp = __name((obj, key, value) => key in obj ? __defProp3(obj, key, { enumerable: !0, configurable: !0, writable: !0, value }) : obj[key] = value, "__defNormalProp"), __publicField = __name((obj, key, value) => __defNormalProp(obj, typeof key != "symbol" ? key + "" : key, value), "__publicField"), ACTIONS = {
        INIT: "init",
        START: "start",
        STOP: "stop",
        RESET: "reset",
      ...
      defaultState = {
        ...
        size: 0,
        status: STATUS2.IDLE
      }, validKeys = objectKeys(omit(defaultState, "controlled", "size")), Store = (_a = class {
        constructor(options) {
      ...
      Spotlight_default = JoyrideSpotlight, JoyrideOverlay = (_a2 = class extends Component {
        constructor() {
        ...
        componentDidUpdate(previousProps) {
          ...
          changed("lifecycle", LIFECYCLE.TOOLTIP) && ((_a9 = this.scrollParent) == null || _a9.addEventListener("scroll", this.handleScroll, { passive: !0 }), setTimeout(() => {
            let { isScrolling } = this.state;
        ...
        componentWillUnmount() {
          var _a9;
          this.isActive = !1, window.removeEventListener("mousemove", this.handleMouseMove), window.removeEventListener("resize", this.handleResize), clearTimeout(this.resizeTimeout), clearTimeout(this.scrollTimeout), (_a9 = this.scrollParent) == null || _a9.removeEventListener("scroll", this.handleScroll);
        }
        get overlayStyles() {
        ...
        get spotlightStyles() {
          ...
          return {
            ...
            height: Math.round(((_a9 = elementRect?.height) != null ? _a9 : 0) + spotlightPadding * 2),
      ...
      }, __name(_a2, "JoyrideOverlay"), _a2), JoyridePortal = (_a3 = class extends Component {
        constructor() {
      ...
      }, __name(_a3, "JoyridePortal"), _a3), Scope = (_a4 = class {
      ...
      }, __name(_a4, "Scope"), _a4), JoyrideBeacon = (_a5 = class extends Component {
        constructor(props) {
      ...
      Container_default = JoyrideTooltipContainer, JoyrideTooltip = (_a6 = class extends Component {
        constructor() {
      ...
      }, __name(_a6, "JoyrideTooltip"), _a6), JoyrideStep = (_a7 = class extends Component {
        constructor() {
          super(...arguments), __publicField(this, "scope", null), __publicField(this, "tooltip", null), __publicField(this, "handleClickHoverBeacon", (event) => {
            ...
            }), (_a9 = step.floaterProps) != null && _a9.getPopper && step.floaterProps.getPopper(popper, type);
        ...
        componentDidUpdate(previousProps) {
          ...
          changedFrom("lifecycle", LIFECYCLE.INIT, LIFECYCLE.READY) && store.update({
            ...
            step,
            type: EVENTS.TOOLTIP
          }), shouldScroll2 && this.tooltip && (this.scope = new Scope(this.tooltip, { selector: "[data-action=primary]" }), this.scope.setFocus())), changedFrom("lifecycle", [LIFECYCLE.TOOLTIP, LIFECYCLE.INIT], LIFECYCLE.INIT) && ((_a9 = this.scope) == null || _a9.removeScope(), store.cleanupPoppers());
        }
        componentWillUnmount() {
          var _a9;
          (_a9 = this.scope) == null || _a9.removeScope();
        }
        get open() {
      ...
      }, __name(_a7, "JoyrideStep"), _a7), Joyride = (_a8 = class extends Component {
        constructor(props) {
          ...
          if (status === STATUS2.RUNNING && shouldScrollToStep) {
            ...
            scrollY = scrollY >= 0 ? scrollY : 0, status === STATUS2.RUNNING && scrollTo(scrollY, { element: scrollParent2, duration: scrollDuration }).then(
              () => {
                setTimeout(() => {
                  var _a9;
                  (_a9 = this.store.getPopper("tooltip")) == null || _a9.instance.update();
                }, 10);
              }
            );
          }
...
`, Button2 = forwardRef(__name(function({ children, onClick, variant = "primary", ...rest }, ref) {
        return react_default.createElement(StyledButton, { ref, onClick, variant, ...rest }, children);
      }, "Button")), TooltipBody = styled.div`
  padding: 15px;
  border-radius: 5px;
`, Wrapper2 = styled.div`
  display: flex;
...
`, Tooltip = __name(({
    ...
    `, document.head.appendChild(style), () => {
      ...
      Content = styled(Modal.Content)(({ theme: theme2 }) => ({
        ...
        gap: 14,
        marginBottom: 8
      }), Question = styled.div(({ theme: theme2 }) => ({
        marginTop: 8,
        marginBottom: 2,
        ...
        }), updateFormData = __name((key, optionOrValue, value) => {
        ...
        }, "updateFormData"), isValid = Object.values(formFields).every((field) => field.required ? Object.values(field.values).some((value) => value === !0) : !0), onSubmitForm = __name((e2) => {
        ...
        return react_default.createElement(Modal, { defaultOpen: !0, width: 420, onEscapeKeyDown: onDismiss }, react_default.createElement(Form, { onSubmit: onSubmitForm, id: "intent-survey-form" }, react_default.createElement(Content, null, react_default.createElement(Modal.Header, null, react_default.createElement(Modal.Title, null, "Help improve Storybook")), Object.keys(formFields).map((key) => {
          let field = formFields[key];
    ...
    radial-gradient(circle at 75% 75%, #fc521f99 0%, #fc521f77 18%, transparent 30%)`,
      ...
      radial-gradient(circle at 75% 75%, #fc521f99 0%, #fc521f77 8%, transparent 20%)`,
      ...
      })), SplashScreen = __name(({ onDismiss, duration = 6e3 }) => {
      ...
      }, "SplashScreen"), SpanHighlight = styled.span(({ theme: theme2 }) => ({
        display: "inline-flex",
        borderRadius: 3,
        padding: "0 5px",
        marginBottom: -2,
        ...
        boxSizing: "border-box",
        lineHeight: "17px"
      })), CodeWrapper = styled.div(({ theme: theme2 }) => ({
  ...
  // node_modules/@storybook/addon-onboarding/dist/manager.js
  var Onboarding2 = lazy(() => Promise.resolve().then(() => (init_Onboarding_XBLXWDOE(), Onboarding_XBLXWDOE_exports)));
  addons.register("@storybook/addon-onboarding", async (api) => {
    ...
    api.once(STORY_SPECIFIED, () => {
      ...
      domNode.id = "storybook-addon-onboarding", document.body.appendChild(domNode), react_dom_default.render(
        react_default.createElement(Suspense, { fallback: react_default.createElement("div", null) }, react_default.createElement(Onboarding2, { api })),
        domNode
      );
    });
  });
